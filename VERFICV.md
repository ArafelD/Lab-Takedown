Módulo 1 — Triangulação Física (a "antena Yagi" de 2026)
...
Módulo 2 — Correlação de Logs Estilo Shimomura (ELK)
...
Módulo 3 — Reconhecimento Ativo com Nmap
...
Módulo 4 — Metadado de Tráfego Estilo Wireshark
...
docker-compose run --rm pcap python analisar_trafego.py
Módulo 5 — OSINT com Lógica de Google Dorking (base local simulada)
